...
\section{Design}
Das Design der Annotationspipeline soll sich an dem \first{Client-Server-Modell}
...
Clients, oder auch \first{Steps}, sind dabei einzelne Verarbeitungsschritte der
...
parallel erfolgen, je nachdem, welche \first{execution preconditions}
...
\subsection{Client}
Clientseitig sollen in der Pipeline die \first{Steps} stehen.
Unter einem \name{Step} soll dabei allgemein eine einzelne Komponente der
Pipeline stehen.
