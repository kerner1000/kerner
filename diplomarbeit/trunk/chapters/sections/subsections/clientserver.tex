...
Ausführungsgerüst.
Die \first{Filter} der Pipeline representieren die \first{Clients}.
...
\begin{figure}[htbp]
	...
	Abstraktion durch das Client-Server-Pattern: einzelne \name{Filter} der
	Pipeline können sich dynamisch an einem \name{Server} an- und abmelden.
